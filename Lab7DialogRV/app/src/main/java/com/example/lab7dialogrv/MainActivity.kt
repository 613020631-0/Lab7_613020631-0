...
import com.example.lab7dialogrv.StudentsAdapter
class MainActivity : AppCompatActivity() {
    ...
    fun studentData(){
        studentList.add(Student("613020631-","Papangkorn", 21))
        studentList.add(Student("613021039-3", "Thitiwarada", 21))
    }
    fun addStudent(view: View){
        ...
        mAlertDialog.btnAdd.setOnClickListener() {studentList.add(
            Student(
